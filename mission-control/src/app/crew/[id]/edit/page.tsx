...
export default function EditAgentPage() {
  ...
  if (loading) {
    return (
      <div className="space-y-6 max-w-2xl">
        <BreadcrumbNav items={[{ label: "Agents", href: "/crew" }, { label: id, href: `/crew/${id}` }, { label: "Edit" }]} />
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <BreadcrumbNav
        items={[{ label: "Agents", href: "/crew" }, { label: agent.name, href: `/crew/${id}` }, { label: "Edit" }]}
      />

      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="icon" onClick={() => router.push(`/crew/${id}`)}>
      ...
      <div className="space-y-5">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <Button variant="ghost" onClick={() => router.push(`/crew/${id}`)}>
            Cancel
          </Button>
        </div>
      </div>
