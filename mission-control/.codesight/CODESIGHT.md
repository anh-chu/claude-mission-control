...
> 86 routes | 0 models | 99 components | 38 lib files | 21 env vars | 4 middleware
...
- **AppSidebar** [client] — props: collapsed, unreadInbox, pendingDecisions, pendingActionApprovals, isMobile, onClose, agents — `src/components/app-sidebar.tsx`
...
- **FieldTaskContextMenuContent** [client] — props: task, onOpen, onEdit, onDelete — `src/components/context-menus/field-task-context-menu.tsx`
...
- `src/lib/logger.ts`
  ...
  - interface Logger
  - type LogLevel
- `src/lib/owner-guard.ts` — function requireOwner: (body, unknown>) => Promise<NextResponse | null>
- `src/lib/paths.ts`
...
## auth
- owner-guard — `src/lib/owner-guard.ts`
...
- `src/lib/types.ts` — imported by **77** files
- `src/lib/utils.ts` — imported by **56** files
- `src/components/ui/button.tsx` — imported by **47** files
- `src/lib/paths.ts` — imported by **39** files
- `src/components/ui/badge.tsx` — imported by **32** files
...
- `src/components/ui/input.tsx` — imported by **21** files
...
- `src/lib/toast.ts` — imported by **14** files
- `src/components/ui/textarea.tsx` — imported by **14** files
- `scripts/daemon/logger.ts` — imported by **13** files
- `src/components/empty-state.tsx` — imported by **11** files

## Import Map (who imports what)

- `src/lib/types.ts` ← `__tests__/data.test.ts`, `src/app/activity/page.tsx`, `src/app/activity/page.tsx`, `src/app/api/activity-log/route.ts`, `src/app/api/agents/route.ts` +72 more
...
- `src/components/ui/button.tsx` ← `src/app/autopilot/page.tsx`, `src/app/brain-dump/page.tsx`, `src/app/checkpoints/page.tsx`, `src/app/crew/[id]/edit/page.tsx`, `src/app/crew/[id]/page.tsx` +42 more
...
- `src/components/ui/badge.tsx` ← `src/app/activity/page.tsx`, `src/app/autopilot/page.tsx`, `src/app/brain-dump/page.tsx`, `src/app/checkpoints/page.tsx`, `src/app/crew/[id]/edit/page.tsx` +27 more
- `src/components/breadcrumb-nav.tsx` ← `src/app/activity/page.tsx`, `src/app/autopilot/page.tsx`, `src/app/brain-dump/loading.tsx`, `src/app/brain-dump/page.tsx`, `src/app/checkpoints/page.tsx` +26 more
- `src/lib/data.ts` ← `__tests__/seeding.test.ts`, `src/app/api/activity-log/route.ts`, `src/app/api/agents/route.ts`, `src/app/api/brain-dump/route.ts`, `src/app/api/checkpoints/export/route.ts` +23 more
...
- `src/components/ui/input.tsx` ← `src/app/autopilot/page.tsx`, `src/app/checkpoints/page.tsx`, `src/app/crew/[id]/edit/page.tsx`, `src/app/crew/[id]/page.tsx`, `src/app/crew/new/page.tsx` +16 more
